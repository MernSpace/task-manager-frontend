    ...
    return (
        <Fragment>
            ...
            <div ref={(div) =>{sideNavRef=div}} className="side-nav-open">
                ...
                <NavLink className={(navData) => navData.isActive ? "side-bar-item-active text-decoration-none  side-bar-item mt-2" : "side-bar-item mt-2 text-decoration-none" } to="/Progress" >
